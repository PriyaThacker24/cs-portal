        ...
        <div class="timelog-drawer-body">
            ...
            <form id="timelog_form" method="post">
                ...
                <div id="timelog_other_fields" style="display: none;">
                    <!-- Tasks/Feedback -->
                    <div class="form-group" id="timelog_task_group">
                        <label for="timelog_task"><?= _l('tasks_feedback'); ?> <span class="text-danger">*</span></label>
                        <select id="timelog_task" name="task_id" class="form-control selectpicker" data-live-search="true">
                    ...
                    <!-- Task Heading (Shown when general log is selected) -->
                    <div class="form-group" id="timelog_task_heading_group" style="display: none;">
                        <label for="timelog_task_heading"><?= _l('task_heading'); ?> <span class="text-danger">*</span></label>
                        <input type="text" id="timelog_task_heading" name="task_heading" class="form-control" placeholder="<?= _l('enter_task_heading'); ?>">
                        <div class="help-block">
                            <a href="javascript:void(0);" id="link_select_task"><?= _l('select_task'); ?></a>
                        </div>
                    </div>
