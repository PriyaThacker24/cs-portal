            ...
            <div class="row">
                        ...
                        <tbody>
                            <tr id="subtotal">
                                ...
                                <td class="subtotal">
                                    ...
                                    <span class="tw-text-neutral-500"><?php echo e($invoice->currency_name); ?></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <span class="bold tw-text-neutral-700"><?php echo e($discount_label); ?></span>
                                </td>
                                <td class="discount">
                            ...
                            <?php
                                foreach ($items->taxes() as $tax) {
                                    echo '<tr class="tax-area"><td class="bold !tw-text-neutral-700">' . e($tax['taxname']) . ' (' . e(app_format_number($tax['taxrate'])) . '%)</td><td>' . e(app_format_money($tax['total_tax'], $invoice->currency_name)) . '<span class="tw-text-neutral-500">' . e($invoice->currency_name) . '</span></td></tr>';
                                }           
                            ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e('-' . app_format_money($credits_applied, $invoice->currency_name)); ?><span class="tw-text-neutral-500"><?php echo e($invoice->currency_name); ?></span>
                                </td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="<?php echo $invoice->total_left_to_pay > 0 ? 'text-danger': ''; ?>">
                                        <?php echo e(app_format_money($invoice->total_left_to_pay, $invoice->currency_name)); ?> <span><?php echo e($invoice->currency_name); ?></span>
                                    </span>
                                </td>
                            </tr>
                            <?php } ?>
               ...
               if ($total_payments > 0) { ?>
                   ...
                   echo ' - ' . $payment['paymentmethod'];
                                ...
                                <!-- <td><?php echo !empty($payment['amount_rupees']) ? e($payment['amount_rupees']) : '-'; ?></td> -->
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
