            ...
            <table class="table text-right">
                <tbody>
                    ...
                    <?php if (is_sale_discount_applied($invoice)) {
                        $discount_label = (isset($invoice->discount_label) && !empty($invoice->discount_label)) ? $invoice->discount_label : _l('invoice_discount');
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="<?php echo $invoice->total_left_to_pay > 0 ? 'text-danger ': ''; ?>">
                                ...
                                <span><?php echo e($invoice->currency_name); ?></span>
                            </span>
                        </td>
                    </tr>
                    <?php } ?>
