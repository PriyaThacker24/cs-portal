                ...
                <tbody>
                    ...
                    <?php if (isset($invoice) || isset($add_items)) {
                            ...
                            foreach ($add_items as $item) {
                                ...
                                $amount = app_format_number($amount) . ' ' . $invoice->currency_name;
                                // order input
                ...
                <tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <select name="discount_type" class="selectpicker" data-width="100%"
                                        data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        <option value="" <?php echo (!isset($invoice) || (isset($invoice) && empty($invoice->discount_type))) ? ' selected' : ''; ?>><?php echo _l('no_discount'); ?></option>
                                        <option value="before_tax" <?php if (isset($invoice) && $invoice->discount_type == 'before_tax') { echo 'selected'; } ?>><?php echo _l('discount_type_before_tax'); ?></option>
                                        <option value="after_tax" <?php if (isset($invoice) && $invoice->discount_type == 'after_tax') { echo 'selected'; } ?>><?php echo _l('discount_type_after_tax'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                <div class="col-md-7">
                                    <label for="discount_label" class="control-label"><?php echo _l('discount_label'); ?></label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" id="discount_label" name="discount_label" class="form-control" 
                                        value="<?php echo (isset($invoice) && property_exists($invoice, 'discount_label') && !empty($invoice->discount_label)) ? e($invoice->discount_label) : ''; ?>" 
                                        placeholder="<?php echo _l('discount_label'); ?>">
                                </div>
                            </div>
                        </td>
                        <td></td>
